...
nnoremap <M-j> <Cmd>call init#mapping#move(v:count1, "\<lt>M-j>")<CR>
nnoremap <M-k> <Cmd>call init#mapping#move(-v:count1, "\<lt>M-k>")<CR>
inoremap <M-j> <Cmd>call init#mapping#move(v:count1, "\<lt>M-j>")<CR><Cmd>normal gi<CR>
inoremap <M-k> <Cmd>call init#mapping#move(-v:count1, "\<lt>M-k>")<CR><Cmd>normal gi<CR>
